              ...
              <div className="lg:p-8 p-6">
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {selectedProject.tags.map((tag, index) => (
                    <span
                      key={index}
                      className="bg-[#251f38] text-xs font-semibold text-teal-900 rounded-full px-2 py-1"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex gap-4">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-1/2 bg-teal-600 hover:bg-teal-800 text-white lg:px-6 lg:py-2 px-2 py-1 rounded-xl lg:text-xl text-sm font-semibold text-center"
                  >
                    View Live
                  </a>
                </div>
